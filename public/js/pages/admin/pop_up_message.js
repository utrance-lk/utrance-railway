...
const renderCard = function (message){
    ...
    let markup = `<div class='firstname-box content__fields-item'>
            ...
            <a href='/utrance-railway/messageFull?details_id=${message.details_id}' class=''>
            <div class='button'>View</div></a></label><hr>
            <a href='/utrance-railway/message'>
...
//           <use xlink:href='../../../../utrance-railway/public/img/pages/admin/svg/sprite.svg#icon-list'></use></svg>

{/* <svg class='notification__icon navbar__icon'>
<use xlink:href='../../../../utrance-railway/public/img/pages/admin/svg/sprite.svg#icon-cross'></use></svg> */}