...
if (isset($_SESSION['user'])) {
    ...
    if (isset($firstNameError)) {
        $html .= "<input type='text' name='first_name' id='first_name' class='form__input error__placeholder'  placeholder='" . $firstNameError . "'   ></div>";

    } else {
        $html .= "<input type='text' name='first_name' id='first_name' class='form__input'   value='" . App::$APP->activeUser()['first_name'] . "' ></div>";
    ...
    $html .= "<input type='submit' class='btn btn-round-blue margin-b-l margin-t-s' name='save' value='Save Settings'  id='submit-btn'></div></div>";

    // $user_img = App::$APP->activeUser()['user_image'];

    // $html .= "<div class='userpicture-box' id='image_box' name='image_box'>";
    // $html .= "<img src='../../../../utrance-railway/public/img/uploads/$user_img.jpg' alt='user-profile-picture' name='image_preview'  onChange='triggerClick()' id='image_preview' />";
    // $html .= "<input type='file' name='photo' accept='image/*' onChange='displayImage(this)' class='form__upload' id='photo' value=''>";
    // $html .= "<label for='photo'>Choose New Photo</label></div>";
    // $html .= "<div class='search__result-user-managebtnbox'>";
    // $html .= "<div class='btn__save-box'>";
    // $html .= "<input type='submit' class='btn btn-round-blue margin-b-l margin-t-s' name='save' value='Save Settings' onclick='getImage()' id='submit-btn'></div></div></form>";
