                ...
                <form action="" method="POST" class="search-bar__form">
                  ...
                  <div class="search-bar__form-2">
                    ...
                    <div class="searchbar__valuebox searchbar__valuebox-to">
                      <span class="selected__city-to">Matara</span>
                  ...
                  <div class="search-bar__form-3">
                    ...
                    <!-- <div class="searchbar__valuebox searchbar__valuebox-when"> -->
                      <!-- <span class="selected__date">07/23/2020</span> -->
                        <input type="text" id="when" name="when" class="searchbar__valuebox searchbar__valuebox-when selected__date input__when datepicker-here js--input-date"/>
                    <!-- </div> -->
                  </div>
                  <div class="search-btn">
                    ...
                    <!-- <button type="submit" class="btn js--searchbox-search">search <i class="fas fa-search"></i></button> -->
                  </div>
                </form>
              </div>
            </div>
