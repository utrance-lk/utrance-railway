            ...
            <div class="searchbar-main__search">
                <div class="searchbar-main__from-container">
                  <div class="searchbar-main__from">
                    ...
                    <div class="searchbar-main__station--from-container">
                      <div class="searchbar-main__station--from js--from__station" id="js--from__station"></div>
              ...
              <div class="searchbar-main__to-container">
                <div class="searchbar-main__to">
                  <span>To</span>
                  <div class="searchbar-main__station--to js--to__station" id="js--to__station"></div>
                </div>
              ...
              <div>
                <div class="searchbar-main__when">
                  <span>When</span>
                  <input type="date" class="searchbar-main__station--when js--when__date" name="when" />
                </div>
              </div>
            </div>
