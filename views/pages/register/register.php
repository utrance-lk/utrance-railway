		...
		<div class="register__form-box register__container-item">
			<form class="form__container" method="POST">
				...
				<div class="lastname-box form__container-item register__form--inputs">
					...
					<input type="text" id="last_name" name="last_name" placeholder="<?php echo isset($lastNameError) ? $lastNameError :'Smith';?>" required>
				...
				<div class="streetline1-box form__container-item register__form--inputs">
					...
					<input type="text" id="streetline1" name="street_line1" placeholder="<?php echo isset($streetLine1Error) ? $streetLine1Error :'22/50, Agathuduwa Watta';?>" required>
                    
				</div>
				<div class="streetline2-box form__container-item register__form--inputs">
					<label for="streetline2">Street line 2</label>
					<input type="text" id="streetline2" name="street_line2" placeholder="<?php echo isset($streetLine2Error) ? $streetLine2Error :'Godagama West';?>" required>
                ...
                <div class="contactno-box form__container-item register__form--inputs">
                    ...
                    <input type="text" id="contactno" name="contact_num" placeholder="<?php echo isset($contactNumError) ? $contactNumError :'07*1234567';?>" required>
