<div id="user_header" >
        ...
        <br>
        <br>
        <text class="update_text"><i class="fa fa-users" aria-hidden="true"></i>&nbsp;&nbsp;User Role</text>
        <br>
        <br>
        <select class="select_city">
            <option class="city_values" value="Matara">Admin</option>
            <option class="city_values" value="Weligama">Registered User</option>
            <option class="city_values" value="Galle">Source Provider</option>
