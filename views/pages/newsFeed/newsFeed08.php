        ...
        <div class="load-content">
          <div class="load-content--settings">
            <div class="content-title">
              <p>New trains will be introduced next year</p>
              <br>
            </div>
<div class="row">
  <div class="columnFull">
    <div class="cardFull">
      <img src="/utrance-railway/public/img/pages/newsFeed/train8.jpg" style="width:100%">
      <div class="container">
       <br>
        <p style="text-align:justify;">Under the development scehme of the country railway, and considering the increase in the number of passengers, new trains will be introduced in Sri Lanka from the next year onwards. It is expected that atleast two new trains will be introduced next year. The details regarding this will be published later. According to sources, these new trains will be modern trains with more facilities. These trains will be a pioneer in railway transport in SriLanka. MOst of our people are using trains as their mode of trainsport. Therefore our new goervnment plans to implement many more advanced schemes in this sector and introduce many systems. The automation of ticket booking is one of them. The fund for this project is already allocated in the last parliament meeting. The proceudre will officially start from next month. It is expected that this project will increase the emplyment in SriLanka as well. </p>
        <br>
