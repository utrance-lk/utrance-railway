...
<body >
    <div id="newsFeed"  >
        <div class="newsCollection" style="float: left;">
            ...
            <div class="newFedd_content" style="font-family:Aldrich;cursor: pointer;padding: 10px;">Tommorow railway department will added aditional train to Matara to Colombo<button class="button" style="vertical-align:middle"><span>More Details</span></button> </div>
